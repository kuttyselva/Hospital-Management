...
public class BranchDao {
	...
	/*
	 * creates new Branch record gets input into Branch bean input Branch record
	 * output true for successful insertion
	 */

	/**
	 * @param branchRecord of branch.
	...
	/*
	 * gets branch record input branch name output branchrecord for successful
	 * Execution
	 */
	/**
	...
	/**
	 * @param patientName in branch.
	 * @param doctorName  in branch.
	 * @param branchName  in branch.
	 * @return true for success.
	 */
