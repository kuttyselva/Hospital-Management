...
public class HospitalDao {
	...
	/*
	 * creates new Hospital record gets input into hospital bean input hospital
	 * record output true for successful insertion
	 */
	/**
	 * @param hospitalRecord new Hospital record.
	...
	/*
	 * updates hospital record input hospital record output true for successful
	 * update
	 */
	/**
	 * @param hospitalName   input hospital record.
	 * @param hospitalRecord input hospital record.
